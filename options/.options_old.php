...
function avatar_image_field_render($args) {
	...
	if (!$image_url) echo ' style="display:none;"';
	echo '>Remove Image</button>';
	echo '<p>Please try to upload a square image, or edit your image to be a sqaure.</><p>If no image is uploaded, a default or your gravatar will be used.</p>';
}
